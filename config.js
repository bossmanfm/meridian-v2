...
export const config = {
  ...
  llm: {
    ...
    managementModel: u.managementModel ?? process.env.LLM_MODEL ?? "deepseek-v4-pro",
    screeningModel:  u.screeningModel  ?? process.env.LLM_MODEL ?? "deepseek-v4-pro",
    generalModel:    u.generalModel    ?? process.env.LLM_MODEL ?? "deepseek-v4-pro",
  },
